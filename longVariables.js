var postOnlineScenarioText = "You notice your friend has a picture of both" + "\n" + "of you in your school uniform on their profile picture" + "\n" + "on Facebook and has also shared their telephone number." + "\n" + "What do you do next?"
...
var spendTimeOfflineOption1ExplanationText = "Parents can often seem overbearing but" + "\n" + "it’s only because they care. The internet is great" + "\n" + "but it can often be dangerous, and it’s" + "\n" + "wise to take the advice of the adults in your life."
var spendTimeOfflineOption2ExplanationText = "Getting away from the computer and watching" + "\n" + "TV instead gives you a break, but this doesn’t" + "\n" + "address the problem at hand fully."
var spendTimeOfflineOption3ExplanationText = "Getting out and socialising in an environment" + "\n" + "separate from lots of technology is often helpful" + "\n" + "to help you refresh."


var homeworkScenarioText = "Your homework is a research project on rivers." + "\n" + "You google your information and click on the" + "\n" + "first website that comes up - it seems to have a lot" + "\n" + "of the information that you need. What do you do next?"
